...
export const Primary: ButtonStory = {
  render: ({ color, text, onClick }) => (
    <>
      ...
      <Button variant="primary" color={color} iconOnly onClick={onClick}>
...
export const Secondary: ButtonStory = {
  render: ({ color, text, onClick }) => (
    <>
      ...
      <Button variant="secondary" color={color} iconOnly onClick={onClick}>
        <BoltIcon className="h-6 w-6" />
      </Button>
    </>
  ),
...
export const Outline: ButtonStory = {
  render: ({ color, text, onClick }) => (
    <>
      ...
      <Button variant="outline" color={color} iconOnly onClick={onClick}>
        <BoltIcon className="h-6 w-6" />
      </Button>
    </>
  ),
...
export const Ghost: ButtonStory = {
  render: ({ color, text, onClick }) => (
    <>
      ...
      <Button variant="ghost" color={color} iconOnly onClick={onClick}>
        <BoltIcon className="h-6 w-6" />
      </Button>
    </>
  ),
...
export const Selected: ButtonStory = {
  render: ({ color, text, onClick }) => (
    <>
      ...
      <Button variant="selected" color={color} iconOnly onClick={onClick}>
        <BoltIcon className="h-6 w-6" />
      </Button>
    </>
  ),
